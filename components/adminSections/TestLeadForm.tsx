...
/**
 * Create-test-lead form for the unified admin dashboard. Unlike the legacy
 * /admin/create-lead page (which collects ADMIN_TEST_PASSWORD), this form
 * relies on the caller's staff ADMIN session — /api/leads accepts it via
 * authorizedAdminRequest.
 */
export function TestLeadForm({ authHeaders }: { authHeaders: Record<string, string> }) {
