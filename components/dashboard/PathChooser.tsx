...
import { ArrowRight, BookOpen, Clock, Rocket } from "lucide-react";
    ...
    <div className="grid gap-[18px] lg:grid-cols-2">
      <Card className="relative overflow-visible border-primary/30">
        <span className="absolute -top-3 left-6">
          <Badge variant="primary" className="border border-primary-soft-border bg-card shadow-card">
            Recommended
          </Badge>
        </span>
        ...
        <CardContent className="flex h-full flex-col p-6 pt-7 sm:p-7 sm:pt-8">
          ...
          <p className="mt-1.5 text-[13px] leading-[1.6] text-muted-foreground">
            Start with a guided overview of the business model, investment process, ownership
            expectations, and why this opportunity may be a good fit.
          </p>
          <p className="mt-2 text-[12.5px] font-medium text-primary">Most investors start here.</p>

          <div className="mt-auto pt-5">
            <Button asChild size="lg" className="w-full">
              <Link href={`${base}/overview`}>
                Continue Investor Overview <ArrowRight />
              </Link>
            </Button>
