    ...
    <span className="inline-flex items-center gap-2">
      <span className="relative flex size-8 shrink-0 items-center justify-center">
        <svg viewBox="0 0 36 36" className="size-full -rotate-90">
          <circle cx="18" cy="18" r={radius} fill="none" stroke="var(--border-soft)" strokeWidth="3.5" />
          <circle
            cx="18"
            cy="18"
            r={radius}
      ...
      <span className="text-xs font-medium text-secondary-foreground">{Math.round(clamped)}%</span>
    </span>
  );
}
