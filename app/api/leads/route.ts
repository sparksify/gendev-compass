...
export async function POST(request: Request): Promise<NextResponse> {
  ...
  try {
    ...
    let lead = await store.createLead({
      ...
      first_utm_source: input.utmSource ?? null,
      first_utm_medium: input.utmMedium ?? null,
      first_utm_campaign: input.utmCampaign ?? null,
      first_utm_content: input.utmContent ?? null,
      first_utm_term: input.utmTerm ?? null,
      first_fbclid: input.fbclid ?? null,
      ...
      facebook_adset_id: input.facebookAdsetId ?? null,
