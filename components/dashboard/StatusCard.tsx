...
export function StatusCard({
  ...
  return (
    <Card className="overflow-hidden">
      <div className="flex flex-col gap-5 px-6 pb-6 pt-5 sm:flex-row sm:items-stretch sm:justify-between sm:gap-8 sm:px-9 sm:pb-6 sm:pt-6">
      ...
      <div id="progress" className="overflow-x-auto border-t border-border px-6 pb-3.5 pt-3 sm:px-8">
